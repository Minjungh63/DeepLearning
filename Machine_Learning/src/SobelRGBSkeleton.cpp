		...
		for (int j = 0; j < col; j++) {
			...
			for (int a = -n; a <= n; a++) {
				for (int b = -n; b <= n; b++) {
					...
					sum1_r += sqrt((float)(input.at<C>(tempa, tempb)[0]) * (kernel_x.at<G>(a + n, b + n) + kernel_y.at<G>(a + n, b + n)));
					sum1_g += sqrt((float)(input.at<C>(tempa, tempb)[1]) * (kernel_x.at<G>(a + n, b + n) + kernel_y.at<G>(a + n, b + n)));
					sum1_b += sqrt((float)(input.at<C>(tempa, tempb)[2]) * (kernel_x.at<G>(a + n, b + n) + kernel_y.at<G>(a + n, b + n)));
