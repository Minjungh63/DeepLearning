#purpose
Apply Sobel Filter to color image
...
1. UnsharpMash function: input image(color image)
2. hist_eq_color: input image, equalized image(->save output image), trans_func(-> save trans_func value),CDF of input image
