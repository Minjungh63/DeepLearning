...
class Unet(nn.Module):
    def __init__(self, in_channels=3, out_channels=22):
        ...
        self.upsample = nn.Upsample(scale_factor=2, mode='bilinear', align_corners=True) # width x2, height x2, channel x2
        self.convUp4 = conv(1536, 512)  # input_channels: 512*2 + 512 = 1536
        self.convUp3 = conv(768, 256)   # input_channels: 256*2 + 256 = 768
        self.convUp2 = conv(384, 128)   # input_channels: 128*2 + 128 = 384
        self.convUp1 = conv(192, 64)    # input_channels: 64*2 + 64 = 192
